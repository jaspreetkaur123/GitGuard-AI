    ...
    >
      <div
        style={{
          ...
          gap: '8px',
          fontSize: '0.875rem',
          color: settings.security ? 'var(--text)' : 'var(--text-muted)',
        }}
      >
        <Shield size={16} /> Security
      </div>
      ...
      <div
        style={{
          ...
          gap: '8px',
          fontSize: '0.875rem',
          color: settings.performance ? 'var(--text)' : 'var(--text-muted)',
        }}
      >
        <Zap size={16} /> Performance
      </div>
      ...
      <div
        style={{
          ...
          gap: '8px',
          fontSize: '0.875rem',
          color: settings.bestPractices ? 'var(--text)' : 'var(--text-muted)',
        }}
      >
        <BookOpen size={16} /> Best Practices
      </div>
...
const Settings = () => {
  // ✅ GitHub OAuth handler (ONLY IMPORTANT ADDITION)
  const handleGithubConnect = () => {
    const clientId = "Ov23likH0UCgR93V9dp1";
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
      <header>
        ...
        <p style={{ color: 'var(--text-muted)' }}>
          Configure how GitGuard AI interacts with your projects.
        </p>
      </header>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
          <h3 style={{ fontSize: '1.125rem' }}>Add New Repository</h3>
          <span style={{ fontSize: '0.875rem', color: 'var(--text-muted)' }}>
            Import more repositories from your GitHub account.
          </span>
        </div>

        {/* ✅ FINAL BUTTON */}
        <button className="btn-primary" onClick={handleGithubConnect}>
          Configure on GitHub
        </button>
      </div>
    </div>
